...
<div class="hello">
    ...
    <el-upload class="upload-demo" drag action="https://jsonplaceholder.typicode.com/posts/" v-bind:on-preview="handlePreview" v-bind:on-remove="handleRemove" v-bind:file-list="fileList" v-bind:on-change="listChanged" v-bind:auto-upload="false" multiple> <i class="el-icon-upload"></i>
